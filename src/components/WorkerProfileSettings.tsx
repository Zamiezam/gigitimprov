          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-outline-variant p-5 text-center shadow-xs">
                ...
                {/* Section 4: Weekly Availability Schedule */}
                <div>
                  ...
                  <p className="text-[10px] text-on-surface-variant mb-4 leading-relaxed">Set your weekly availability. Employers will see this when looking for backup workers in the Emergency Pool.</p>
                  
                  <div className="space-y-4 bg-surface-container-lowest p-4 rounded-xl border border-outline-variant">
                    <div>
                      <span className="block text-[10px] text-on-surface-variant font-bold uppercase tracking-wider mb-2">Days Available</span>
                    ...
                    <div>
                      <span className="block text-[10px] text-on-surface-variant font-bold uppercase tracking-wider mb-2">Preferred Time Slots</span>
                      <div className="flex flex-wrap gap-2">
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-colors border ${
                              availableTimes.includes(time) 
                                ? 'bg-[#0f4a42] border-[#0f4a42] text-white shadow-sm' 
                                : 'bg-white border-outline-variant hover:bg-surface-container-low text-on-surface'
                            }`}
                          >
                            {time}
